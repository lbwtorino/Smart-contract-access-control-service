...
AStorage = new LocalStorage('./data/position/MultipleA');
...
function grantTickets(type, message, verify_private_key, access_time, contract_name, deployed_address) {
    ...
    switch(type) {
        ...
        case 3:
            ...
            
            ...
            
            ...
            // var _whole_msg = receiver +type.toString() +access_time.toString() + _index.toString()+ message[0].substring(2)+pad(64-message[0].substring(2).length) + web3.utils.sha3('withdrawBalance(uint256,bytes32[],uint256[],uint256[],uint8[],bytes1[],bytes32[],bytes32[])').substring(0,10)+ argValue + receiver + typeTicket + expirationTime + onetime;
...
function verifyPolicy(type, msg, contract_name){
    var counter = 0;
    if (counter == 0){
        white_list = JSON.parse(policyStorage.getItem('MultipleDacs')).white;
        black_list = JSON.parse(policyStorage.getItem('MultipleDacs')).black;
