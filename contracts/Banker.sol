...
contract Banker{
    ...
    function Banker(address private_key) public {
        owner = msg.sender;
   ...
   function withdraw(uint amount, bytes32[] _addr, uint[] _type, uint[] _time, uint8[] _index, byte[] _v, bytes32[] _r, bytes32[] _s) payable {
