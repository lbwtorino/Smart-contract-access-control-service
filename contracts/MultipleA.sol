...
contract MultipleA{
    ...
    function MultipleA(address _t, address private_key) public {
        owner = msg.sender;
   ...
   function getInfor() public returns (uint, bytes, string, address){
       return (va, test, ttttt, verify_public_key);
   }
