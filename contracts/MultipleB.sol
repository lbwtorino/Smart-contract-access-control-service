...
contract MultipleB{
    ...
    MultipleC multipleC;
    function MultipleB(address _t, address private_key) public {
        owner = msg.sender;
        verify_public_key = private_key;
        multipleC =  MultipleC(_t);
    }
   ...
   uint va;
    ...
    function withdrawBalance(uint val, bytes32[] _addr, uint[] _type, uint[] _time, uint8[] _index, byte[] _v, bytes32[] _r, bytes32[] _s) public {
        ...
        multipleC.withdrawBalance(val, _addr, _type,  _time, _index, _v, _r, _s);
    }
